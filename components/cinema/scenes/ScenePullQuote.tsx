  ...
  return (
    ...
    >
      <blockquote className="max-w-[64ch]">
        <p className="font-medium italic leading-[1.25] tracking-[-0.005em] text-fg/95 [font-size:clamp(22px,min(5.5vw,8vh),56px)] [text-shadow:_0_1px_3px_rgba(0,0,0,0.3),_0_0_24px_rgba(0,0,0,0.16)]">
          <T value={scene.text} />
        </p>
        {scene.subtitle ? (
          <p className="mt-6 font-medium italic leading-[1.35] text-fg/75 [font-size:clamp(13px,min(2.4vw,3.5vh),28px)] [text-shadow:_0_1px_2px_rgba(0,0,0,0.25)]">
